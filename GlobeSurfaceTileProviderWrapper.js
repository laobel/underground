...
/**
 * change globe's pass to Pass.TRANSLUCENT
 */
function GlobeSurfaceTileProviderWrapper() {
 ...
 * for Cesium 1.51
 */
GlobeSurfaceTileProviderWrapper.activate151 = function() {
    var BoundingSphere = Cesium.BoundingSphere;
    var BoxOutlineGeometry = Cesium.BoxOutlineGeometry;
    ...
    var SphereOutlineGeometry = Cesium.SphereOutlineGeometry;
    var TerrainMesh = Cesium.TerrainMesh;
    var TerrainQuantization = Cesium.TerrainQuantization;
    var Visibility = Cesium.Visibility;
    ...
    var GlobeSurfaceTile = Cesium.GlobeSurfaceTile;
    var ImageryLayer = Cesium.ImageryLayer;
    var PerInstanceColorAppearance = Cesium.PerInstanceColorAppearance;
    var Primitive = Cesium.ImageryLayer;
    var QuadtreeTileLoadState = Cesium.QuadtreeTileLoadState;
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.update = function(frameState) {
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.initialize = function(frameState) {
     ...
     * @param {FrameState} frameState The frame state.
     */
    Cesium.GlobeSurfaceTileProvider.prototype.beginUpdate = function(frameState) {
     ...
     * @param {FrameState} frameState The frame state.
     */
    Cesium.GlobeSurfaceTileProvider.prototype.updateForPick = function(frameState) {
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.cancelReprojections = function() {
        this._imageryLayers.cancelReprojections();
    };

    /**
     * Gets the maximum geometric error allowed in a tile at a given level, in meters.  This function should not be
     * called before {@link Cesium.GlobeSurfaceTileProvider#ready} returns true.
     *
     * @param {Number} level The tile level for which to get the maximum geometric error.
     * @returns {Number} The maximum geometric error in meters.
     */
    Cesium.GlobeSurfaceTileProvider.prototype.getLevelMaximumGeometricError = function(level) {
     ...
     * not be called before {@link Cesium.GlobeSurfaceTileProvider#ready} returns true.
     *
     * @param {FrameState} frameState The frame state.
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.loadTile = function(frameState, tile) {
     ...
     * to {@link Cesium.GlobeSurfaceTileProvider#showTileThisFrame}.
     *
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.computeTileVisibility = function(tile, frameState, occluders) {
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.showTileThisFrame = function(tile, frameState) {
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.computeDistanceToTile = function(tile, frameState) {
        var surfaceTile = tile.data;
     ...
     *
     * @see Cesium.GlobeSurfaceTileProvider#destroy
     */
    Cesium.GlobeSurfaceTileProvider.prototype.isDestroyed = function() {
        return false;
    };
     ...
     *
     * @see Cesium.GlobeSurfaceTileProvider#isDestroyed
     */
    Cesium.GlobeSurfaceTileProvider.prototype.destroy = function() {
    ...
    Cesium.GlobeSurfaceTileProvider.prototype._onLayerAdded = function(layer, index) {
        if (layer.show) {
    ...
    Cesium.GlobeSurfaceTileProvider.prototype._onLayerRemoved = function(layer, index) {
    ...
    Cesium.GlobeSurfaceTileProvider.prototype._onLayerMoved = function(layer, newIndex, oldIndex) {
        this._layerOrderChanged = true;
        this._imageryLayersUpdatedEvent.raiseEvent();
    };

    Cesium.GlobeSurfaceTileProvider.prototype._onLayerShownOrHidden = function(layer, index, show) {
        if (show) {
 ...
 * for Cesium 1.59
 */
GlobeSurfaceTileProviderWrapper.activate159 = function() {
    var BoundingSphere = Cesium.BoundingSphere
    var BoxOutlineGeometry = Cesium.BoxOutlineGeometry
    var Cartesian2 = Cesium.Cartesian2
    var Cartesian3 = Cesium.Cartesian3
    ...
    var SceneMode = Cesium.SceneMode
    var ShadowMode = Cesium.ShadowMode
    var TileBoundingRegion = Cesium.TileBoundingRegion
    var TileSelectionResult = Cesium.TileSelectionResult
    var TerrainFillMesh = Cesium.TerrainFillMesh
    var TerrainState = Cesium.TerrainState
    var ImageryState = Cesium.ImageryState
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.canRefine = function(tile) {
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.canRenderWithoutLosingDetail = function(tile, frameState) {
        var surfaceTile = tile.data;
     ...
     */
    Cesium.GlobeSurfaceTileProvider.prototype.computeTileLoadPriority = function(tile, frameState) {
        var surfaceTile = tile.data;
